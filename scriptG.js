...
const discardPile = [];
// itererar genom händerna 2 gånger
for (let i = 0; i < 2; i++) {
    discardPile.push(player1.hand.pop()); //tar bort 1 kort från spelarens hand och lägger till i kasthögen "discardPile"
    discardPile.push(player2.hand.pop()); //tar bort 1 kort från spelarens hand och lägger till i kasthögen "discardPile"
}
